-- DROP TABLE IF EXISTS files,tags,filetags,questions,questionoptions;
-- DELETE FROM storage.buckets WHERE name='files' OR name='thumbs';
-- DROP TRIGGER IF EXISTS update_files_table_when_storage_updates ON storage.objects;
-- DROP FUNCTION IF EXISTS storage.update_files_referencing_storageid;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1m0cqf_0" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1m0cqf_1" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1m0cqf_2" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1m0cqf_3" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1kkjs65_0" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1kkjs65_1" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1kkjs65_2" ON storage.objects;
-- DROP POLICY IF EXISTS "Allow all users to perform all operations 1kkjs65_3" ON storage.objects;
